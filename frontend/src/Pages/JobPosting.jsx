...
function JobPosting() {
  ...
  return (
    <div className="py-3 px-2 md:px-8 lg:px-20">
      <div className="my-5">
        <h2 className="font-semibold text-2xl">Nouvelle offre d'emploi</h2>
      </div>
      <div className="border rounded">
        <div className="p-3 font-medium text-lg px-5 border-b">
          1. Détails de l'emploi
        </div>
        <div className="p-5">
          <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <span className="text-gray-500 text-sm ml-1.5 ">
                Saisissez les compétences requises pour le poste dans la liste
                déroulante du champ "Compétences".
              </span>
              <SkillsSearch
            ...
            <div className="flex flex-col space-y-2">
              <span className="font-semibold text-lg">Mode de travail</span>
              <span className="text-sm text-gray-500">
                Veuillez sélectionner votre mode de travail préféré{" "}
              </span>
