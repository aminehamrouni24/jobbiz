          ...
          <div className="h-full w-full sm:text-right sm:pr-12 bg-black sm:pt-24 sm:pl-14 text-green-500 sm:rounded-t-lg lg:pt-44">
            <h2 className="py-4 text-xl text-center sm:text-5xl sm:text-right font-bold sm:mb-5 sm:pl-4 xl:text-6xl ">
              {userType === "jobSeeker"
                ...
                : userType === "employer" &&
                  (Math.random() > 0.5
                    ? "Découvrez la solution idéale pour votre équipe."
                    : "Découvrez le joyau dont votre organisation a besoin.")}
            </h2>

            <p className="hidden sm:block font-light sm:pl-3 sm:text-lg text-white xl:text-xl xl:pl-16">
              {userType === "jobSeeker"
                ? "Parcourez plus de 130 000 offres d'emploi dans des entreprises de premier plan et des start-ups à croissance rapide."
                : "Parcourez une vaste réserve de chercheurs d'emploi talentueux."}
            </p>
          </div>
        </div>
