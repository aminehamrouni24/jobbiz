      ...
      <div className="flex flex-wrap justify-between px-5 gap-2 my-8">
        <div className="h-16 w-56 rounded-xl border shadow flex gap-5 items-center justify-center hover:cursor-pointer">
          ...
          <div className="flex flex-col justify-center ">
            ...
            <p className="text-xs text-gray-500">Liste des emplois</p>
          </div>
        </div>
        ...
        <div className="h-16 w-56 rounded-xl border shadow flex gap-5 items-center justify-center hover:cursor-pointer">
          ...
          <div className="flex flex-col justify-center ">
            ...
            <p className="text-xs text-gray-500">Nouvelles applications</p>
          </div>
        </div>
        <div className="h-16 w-56 rounded-xl border shadow flex gap-5 items-center justify-center hover:cursor-pointer">
          ...
          <div className="flex flex-col justify-center ">
            ...
            <p className="text-xs text-gray-500">Demandes fermés</p>
          </div>
        </div>
          ...
          <Table className="mt-5">
            <TableHead>
              <TableRow>
                ...
                <TableHeaderCell>Voir l'offre</TableHeaderCell>
              </TableRow>
            </TableHead>
            <TableBody>
