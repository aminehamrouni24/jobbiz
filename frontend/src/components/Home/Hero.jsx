    ...
    <div className="md:flex ">
      <div className=" md:w-1/2 bg-gray-200 ">
        <div className="flex flex-col pt-28 pl-8 md:pl-20 gap-6">
          <p className=" font-semibold">_/ Obtenir des stages</p>
          <div className="flex flex-col gap-4">
            <h2 className=" text-5xl font-bold">Le moyen le plus rapide</h2>
            <h2 className=" text-5xl font-bold">Pour Trouver des Emplois...</h2>
          </div>
          <p className="font-medium text-gray-700 pr-10 md:pr-32">
            ...
            , Recevez vos nouvelles offres les plus intéressantes directement
        ...
        <div className="mt-24 flex gap-8 items-center md:items-end justify-center md:justify-normal md:pl-20 pl-14 pb-9 md:pb-0 px-5 md:px-0 md:pt-5">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-3xl font-semibold">1.4 Milles</p>
            <p className=" text-sm font-medium text-gray-700">
              Candidats placés auprès des meilleures entreprises{" "}
            </p>
          </div>
        </div>
      </div>
